...
const friendshipPairs: { [key: string]: string[] } = {
  "Corrin (M)": ["Jakob", "Kaze", "Silas", "Arthur", "Odin", "Niles", "Laslow", "Benny", "Leo", "Xander", "Keaton", "Izana", "Gunter", "Shura"],
  "Jakob": ["Gunter", "Silas"],
  "Kaze": ["Silas", "Xander"],
  "Silas": ["Jakob", "Kaze"],
  ...
  "Gunter": ["Jakob"],
  "Izana": [],
  "Corrin (F)": ["Felicia", "Azura", "Mozu", "Elise", "Effie", "Charlotte", "Camilla", "Selena", "Beruka", "Peri", "Nyx", "Flora"],
  "Felicia": ["Peri", "Flora"],
  "Azura": ["Elise"],
  "Mozu": ["Effie", "Nyx"],
